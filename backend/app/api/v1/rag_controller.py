...
from app.schemas.rag import DocumentChunk, GenerationRequest, GenerationChatRequest
...
#         )
#     limit = min(limit, 50)
#     chunks = rag_service.retrieve_similar_chunks(
#         query=query, limit=limit, session_id=session_id, db=db
#     )
#     return chunks
